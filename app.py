...
# ══════════════════════════════════════════════════════════════════
    ...
    with tab_ag:
        ...
        <div style="background:#fff;border:1px solid #e4e8f0;border-radius:14px;
          ...
          <div style="font-size:13px;color:#9aa0b8;margin-top:3px">{"Guru Bidang Studi" if is_bidstudi else ", ".join(kelas_list) if len(kelas_list)>1 else kelas_guru}</div>
    ...
    with tab_profil:
        ...
        <div style="background:#fff;border:1px solid #e4e8f0;border-radius:12px;padding:20px;margin-bottom:16px">
          <div style="font-size:17px;font-weight:700;color:#1a1d2e">{guru_info['nama']}</div>
          <div style="font-size:14px;color:#9aa0b8;margin-top:4px">{"Guru Bidang Studi" if is_bidstudi else ", ".join(kelas_list) if kelas_list else kelas_guru}</div>
        </div>""", unsafe_allow_html=True)
